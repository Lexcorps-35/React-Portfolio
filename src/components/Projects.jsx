...
const Projects = () => {
  ...
  return (
    <section
      id="projects"
      className="bg-[#f5f5f5] dark:bg-[#0f0f0f] py-16 px-6 mt-8"
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-10" data-aos="fade-up">
          {projects.map((project) => (
            <div
              key={project.id}
              className=" backdrop-blur-2xl dark:bg-white/10 border border-white/10 rounded-xl shadow-lg overflow-hidden transition transform hover:scale-105 hover:shadow-red-400"
            >
              <img
                src={project.image}
                alt={project.title}
              ...
              />
              <div className="p-5">
                <h3 className="text-xl font-semibold text-black dark:text-white -mt-2">
                  {project.title}
                </h3>
